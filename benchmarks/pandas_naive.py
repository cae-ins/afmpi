...
def run_pandas_naive(
    ...
    indicators: list[str],
    weights: str = "weight",
    cutoffs: list[float] = [0.2, 0.25, 0.3, 0.33, 0.4, 0.5, 0.6, 0.7],
    over_vars: list[str] = ["region", "department", "subprefecture"],
) -> dict[str, float]:
...
if __name__ == "__main__":
    ...
    print(f"Pandas naive execution time: {res['elapsed_sec']:.2f}s ({res['num_estimates']} estimates)")
